# AGENTS.md — navier-stokes

## Role: NS-CLUSTER

**Cluster:** Navier–Stokes

**Core claim:** Regularity / blow-up barrier — energy dissipation bounds
...
expressed in the language of Navier–Stokes.

## Entry point for AI agents

Look for `NavierStokes` or `NS` Lean files.
